...
Rails.application.routes.draw do
  ...
  match '/sell_do/:project_id/lead_updated', to: "api/sell_do/leads#lead_created", via: [:get, :post]
  match '/sell_do/:project_id/site_visit_created', to: "api/sell_do/leads#site_visit_updated", via: [:get, :post]
