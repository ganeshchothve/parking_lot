module Reminders
  class PostKycWorker
    ...
    def perform user_id, day
      ...
      email_template = Template::EmailTemplate.where(name: "no_payment_day_#{day.to_i}")
      ...
      sms_template = Template::SmsTemplate.where(name: "no_payment_day_#{day.to_i}")
      Sms.create!(
        booking_portal_client_id: user.booking_portal_client_id,
      ...
      template = Template::NotificationTemplate.where(name: "no_payment_day_#{day.to_i}").first
