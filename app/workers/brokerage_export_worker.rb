...
class BrokerageExportWorker
  ...
  def self.get_invoice_row(invoice)
    invoice_row = [
      ...
      invoice.raised_date.present? ? I18n.l(invoice.raised_date.try(:strftime, '%d/%m/%Y')) : "",
      ...
      invoice.net_amount,
      invoice.approved_date.present? ? I18n.l(invoice.approved_date.try(:strftime, '%d/%m/%Y')) : "",
