class ChannelPartnerMailer < ApplicationMailer
  def send_create channel_partner_id
    ...
    emails = current_client.notification_email if emails.blank?
  ...
  def send_user_activated_with_other channel_partner_id, user_id
    ...
    make_bootstrap_mail(to: current_client.notification_email, subject: "New channel partner registered on your website") if current_client.notification_email.present?
  end
end
