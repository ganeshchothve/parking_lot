class ClientObserver < Mongoid::Observer
  ...
  def after_create client
    ...
    Template::CostSheetTemplate.create(content: Template::CostSheetTemplate.default_content, booking_portal_client_id: client.id, default: true)
    Template::PaymentScheduleTemplate.create(content: Template::PaymentScheduleTemplate.default_content, booking_portal_client_id: client.id, default: true)
