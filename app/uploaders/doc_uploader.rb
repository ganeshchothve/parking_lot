class DocUploader < CarrierWave::Uploader::Base
  ...
  def extension_white_list
    %w(PNG png JPEG jpeg JPG jpg PDF pdf zip ZIP csv CSV)
  ...
  def content_type_whitelist
    ['application/pdf', 'image/jpeg', 'image/png', 'image/jpg', 'application/x-zip-compressed', 'application/zip', 'text/csv']
  end
