  ...
  def check_and_register
    unless request.xhr?
      ...
      if @lead.present?
        ...
        @lead = Lead.new(booking_portal_client_id: current_client.id, email: params['email'], phone: params['phone'], first_name: params['first_name'], last_name: params['last_name'], lead_id: params[:lead_id])
