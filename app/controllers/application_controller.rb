class ApplicationController < ActionController::Base
  ...
  before_action :marketplace_current_user_match, if: proc { current_user.present? && params[:tenantId].present? && params[:userId].present? }
  ...
  def marketplace_current_user_match
    unless current_client.is_marketplace? && current_user.kylas_user_id == params[:userId] && current_client.kylas_tenant_id == params[:tenantId]
      store_user_location!
