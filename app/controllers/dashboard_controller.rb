...
class DashboardController < ApplicationController
  ...
  def payment
    @receipt = Receipt.new(user: current_user, receipt_id: SecureRandom.hex, acounting_date: Date.today, payment_mode: 'online', total_amount: ProjectUnit.blocking_amount, payment_type: 'blocking')
