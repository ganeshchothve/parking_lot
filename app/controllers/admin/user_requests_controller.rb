class Admin::UserRequestsController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @user_request.save
        format.html { redirect_to edit_admin_user_request_path(@user_request, request_type: @user_request.class.model_name.element), notice: I18n.t("controller.accounts.notice.registered") }
  ...
  def update
    ...
    respond_to do |format|
      if @user_request.save
        format.html { redirect_to admin_user_requests_path(request_type: 'all'), notice: I18n.t("controller.user_requests.notice.updated") }
