class Admin::SiteVisitsController < AdminController
  ...
  def update
    ...
    respond_to do |format|
      ...
      if @site_visit.save
        format.html { redirect_to request.referer, notice: I18n.t("controller.site_visits.notice.updated") }
      ...
      begin
        ...
        when Net::HTTPSuccess
          if @site_visit.update_data_from_selldo(JSON.parse(resp.read_body))
            format.html { redirect_to request.referer, notice: I18n.t("controller.site_visits.notice.synced") }
          else
        ...
        format.html { redirect_to request.referer, alert: I18n.t("controller.site_visits.errors.went_wrong") }
      end
    end
  end
