class Admin::DevelopersController < AdminController
  ...
  def update
    ...
    respond_to do |format|
      if @developer.update(parameters)
        format.html { redirect_to request.referrer || admin_developers_path, notice: I18n.t("controller.notice.updated", name: "Developer") }
      else
  ...
  def set_developer
    ...
    redirect_to dashboard_path, alert:  I18n.t("controller.errors.not_found", name: "Developer") unless @developer
  end
