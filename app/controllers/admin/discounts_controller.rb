class Admin::DiscountsController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @discount.save
        format.html { redirect_to admin_discounts_path, notice:  I18n.t("controller.notice.created", name: "#{I18n.t('global.discount.one')}") }
  ...
  def destroy
    respond_to do |format|
      if @discount.destroy
        format.html { redirect_to admin_discounts_path, notice: I18n.t("controller.notice.deleted", name: "#{I18n.t('global.discount.one')}") }
      else
  ...
  def update
    ...
    respond_to do |format|
      if @discount.save
        format.html { redirect_to admin_discounts_path, notice: I18n.t("controller.notice.updated", name: "#{I18n.t('global.discount.one')}") }
