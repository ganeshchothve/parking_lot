module UsersConcern
  ...
  def show
    @project_units = @user.project_units.paginate(page: params[:page] || 1, per_page: params[:per_page] || 15)
    @booking_details = @user.booking_details.paginate(page: params[:page] || 1, per_page: params[:per_page] || 15)

    @receipts = @user.receipts.paginate(page: params[:page] || 1, per_page: params[:per_page] || 15)
