class Buyer::ProjectUnitsController < BuyerController
  ...
  def index
    ...
    respond_to do |format|
      ...
      format.html { redirect_to home_path(current_user), notice: I18n.t("global.only_admins.this_page")}
    end
  end
  ...
  def update
    ...
    respond_to do |format|
      if @project_unit.update(parameters)
        format.html { redirect_to home_path(current_user), notice: I18n.t("controller.project_units.notice.updated") }
      else
