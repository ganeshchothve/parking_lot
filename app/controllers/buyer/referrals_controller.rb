  ...
  def create
    ...
    respond_to do |format|
      if referral_user.blank?
        ...
        flash[:error] = I18n.t("controller.receipts.errors.already_present", name: "#{referral_user.email}")
        format.json { render json: { errors: [I18n.t("controller.receipts.errors.already_present", name: "#{referral_user.email}")] }, status: 422 }
      end
