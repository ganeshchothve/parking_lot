class Buyer::BookingDetailPolicy < BookingDetailPolicy
  ...
  def hold?
    _role_based_check && enable_actual_inventory? && only_for_confirmed_user! && only_for_kyc_added_users! && only_single_unit_can_hold! && available_for_user_group? && is_buyer_booking_limit_exceed? && buyer_kyc_booking_limit_exceed?
  end
