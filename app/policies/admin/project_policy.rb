  ...
  def permitted_attributes(params = {})
    ...
    if user.role?(:superadmin)
      attributes += [
        ...
        :blocking_days, :enable_slot_generation, :booking_price_in_percentage, :booking_price_factor, :holding_minutes, :terms_and_conditions, :email_header, :email_footer, :hot, :enable_inventory, :enable_booking_with_kyc, :gst_slab_applicable, :check_sv_availability_in_selldo, third_party_references_attributes: ThirdPartyReferencePolicy.new(user, ThirdPartyReference.new).permitted_attributes,
