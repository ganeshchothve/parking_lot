  ...
  def permitted_attributes(params = {})
    ...
    if user.role?(:superadmin)
      attributes += [
        ...
        :support_number, :support_email, :channel_partner_support_number, :channel_partner_support_email, :cancellation_amount, :blocking_amount, :project_region, :sv_incentive, :spot_booking_incentive, :pre_reg_incentive_percentage, :pre_reg_min_bookings, :iris_url,
