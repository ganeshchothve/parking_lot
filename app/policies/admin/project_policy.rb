  ...
  def permitted_attributes(params = {})
    ...
    if user.role?(:superadmin)
      attributes += [
        ...
        :blocking_days, :enable_slot_generation, :holding_minutes, :terms_and_conditions, :email_header, :email_footer, :embed_map_tag, :hot, third_party_references_attributes: ThirdPartyReferencePolicy.new(user, ThirdPartyReference.new).permitted_attributes,
