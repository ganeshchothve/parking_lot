class Admin::ProjectPolicy < ProjectPolicy
  ...
  def asset_create?
    %w[superadmin cp_admin].include?(user.role)
  end
  ...
  def permitted_attributes(params = {})
    attributes = [
      :name, :rera_registration_no, :selldo_client_id, :selldo_form_id, :selldo_gre_form_id,
      ...
      :notification_email, :notification_numbers, :sender_email, :registration_name, :area_unit,
