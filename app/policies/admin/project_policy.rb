class Admin::ProjectPolicy < ProjectPolicy
  ...
  def permitted_attributes(params = {})
    attributes = [:developer_name, :micro_market, :possession, :latitude, :longitude, :registration_name, :rera_registration_no, :gst_number, :cin_number, :creator_id, :price_starting_from, :price_upto, :logo, :cover_photo, :embed_map_tag, :foyer_link, project_type: [], category: [], project_segment: [], booking_sources: []]
