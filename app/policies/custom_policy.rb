class CustomPolicy < Struct.new(:user, :enable_users)
  ...
  def self.custom_methods
    %w[schemes incentive_schemes emails smses referrals accounts checklists bulk_upload_reports crms api_logs push_notifications user_kycs sales_board announcements variable_incentive_schemes payment_types].sort
