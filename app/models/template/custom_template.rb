class Template::CustomTemplate < Template
  ...
  SUBJECT_CLASSES = ["SiteVisit", "ProjectUnit", "IncentiveScheme", "User", "Project", "BookingDetail", "Lead", "Scheme", "Receipt", "ChannelPartner", "Invoice", "Client", "UserRequest::Cancellation", "UserRequest::Swap"].freeze
