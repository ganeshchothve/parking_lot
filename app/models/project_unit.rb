class ProjectUnit
  ...
  scope :filter_by_saleable, ->(saleable) { where(saleable: saleable)}
  scope :filter_by_agreement_price, ->(agreement_price) { where(agreement_price: agreement_price)}
  scope :filter_by_all_inclusive_price, ->(all_inclusive_price) { where(all_inclusive_price: all_inclusive_price)}
