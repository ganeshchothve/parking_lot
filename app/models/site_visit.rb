...
class SiteVisit
  ...
  def validate_scheduled_on_datetime
    self.errors.add :base, 'Scheduled On should not be past date more than 4 days' if (self.scheduled_on_changed? && self.scheduled_on < (Date.today - 4.days).beginning_of_day)
  end
