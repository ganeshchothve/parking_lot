class UserKyc
  ...
  validates :pan_number, presence: true, unless: proc { |kyc| kyc.nri? }
  validates :oci, presence: true, if: proc { |kyc| kyc.nri? }
  ...
  validates :configurations, array: { inclusion: { allow_blank: true, in: proc { |_kyc| UserKyc.available_configurations.collect { |x| x[:id] } } } }
  validates :preferred_floors, array: { inclusion: { allow_blank: true, in: proc { |_kyc| UserKyc.available_preferred_floors.collect { |x| x[:id] } } } }
