class IncentiveCalculator
  ...
  def find_all_bookings_for_current_scheme
    ...
    lead_ids = Lead.in(project_id: incentive_scheme.project_id, manager_id: channel_partner.id).distinct(:id)
  ...
  def calculate
    if find_channel_partner && find_incentive_scheme && find_all_bookings_for_current_scheme
