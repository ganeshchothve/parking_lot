...
module DatabaseSeeds
  module NotificationTemplate
    def self.seed client_id
      ...
      Template::NotificationTemplate.create(booking_portal_client_id: client_id, subject_class: "UserRequest::Cancellation", name: "cancellation_request_pending", content: "
      ...
      Template::NotificationTemplate.create(booking_portal_client_id: client_id, subject_class: "UserRequest::Cancellation", name: "cancellation_request_resolved", content: "
        <% if requestable.kind_of?(BookingDetail) %>
      ...
      Template::NotificationTemplate.create(booking_portal_client_id: client_id, subject_class: "UserRequest::Cancellation", name: "cancellation_request_rejected", content: "
        <% if requestable.kind_of?(BookingDetail) %>
      ...
      Template::NotificationTemplate.create(booking_portal_client_id: client_id, subject_class: "UserRequest::Swap", name: "swap_request_rejected", content: "Swap request on your booking of <%= project_unit.name %> at <%= project_unit.project_name %> has been rejected.") if Template::NotificationTemplate.where(name: "swap_request_rejected").blank?
      ...
      Template::NotificationTemplate.create(booking_portal_client_id: client_id, subject_class: "Receipt", name: "receipt_failed", content: "Dear <%= user.name %>, your payment of Rs. <%= total_amount %> has failed (<%= receipt_id %>).") if Template::NotificationTemplate.where(name: "receipt_failed").blank?

      Template::NotificationTemplate.create(booking_portal_client_id: client_id, subject_class: "Receipt", name: "receipt_pending", content: "Dear <%= user.name %>, your payment of Rs. <%= total_amount %> has been collected and will be sent to the <%= user.name %> Team for clearance.") if Template::NotificationTemplate.where(name: "receipt_pending").blank?
      ...
      Template::NotificationTemplate.create(booking_portal_client_id: client_id, subject_class: "Receipt", name: "receipt_available_for_refund", content: "Dear <%= user.name %>, your payment of Rs. <%= total_amount %> is under 'Available For Refund' (<%= receipt_id %>). To view your receipt visit your Portal Dashboard <%= user.dashboard_url %>") if Template::NotificationTemplate.where(name: "receipt_available_for_refund").blank?

      Template::NotificationTemplate.create(booking_portal_client_id: client_id, subject_class: "Receipt", name: "receipt_refunded", content: "Dear <%= user.name %>, your payment (<%= receipt_id %>) of Rs. <%= total_amount %> has been refunded. To view your receipt visit your Portal Dashboard <%= user.dashboard_url %>") if Template::NotificationTemplate.where(name: "receipt_refunded").blank?
      ...
      Template::NotificationTemplate.create(booking_portal_client_id: client_id, subject_class: "BookingDetail", name: "channel_partner_booking_blocked", content: "Dear <%= user.manager.name %>, <%= user.name %> has blocked unit <%= name %>.") if Template::NotificationTemplate.where(name: "channel_partner_booking_blocked").blank?
      ...
      Template::NotificationTemplate.create(booking_portal_client_id: client_id, subject_class: "BookingDetail", name: "channel_partner_booking_confirmed", content: "Dear <%= user.manager.name %>, <%= user.name %> has booked unit <%= name %>.") if Template::NotificationTemplate.where(name: "channel_partner_booking_confirmed").blank?

      Template::NotificationTemplate.create(booking_portal_client_id: client_id, subject_class: "User", name: "user_registered_by_channel_partner", content: "<%= manager.name %> has registered you with <%= booking_portal_client.name %>. To confirm your account with this partner, please click <%= confirmation_url %>. You can also confirm your account using your phone & <%= I18n.t('global.otp') %>.") if Template::NotificationTemplate.where(name: "user_registered_by_channel_partner").blank?
      ...
      Template::NotificationTemplate.create(booking_portal_client_id: client_id, subject_class: "Receipt", name: "daily_payments_report", content: '[<%= Date.current.strftime("%v") %>] Today you received <%= self.class.todays_payments_count %> payments') if Template::NotificationTemplate.where(name: "daily_payments_report").blank?
      ...
      Template::NotificationTemplate.create!(booking_portal_client_id: client_id, subject_class: "User", name: 'no_payment_day_3', content: "Reminder: You are one step away from booking your spot, call on <%= self.booking_portal_client.support_number %> for more information.")  if ::Template::NotificationTemplate.where(name: "no_payment_day_3").blank?

      Template::NotificationTemplate.create!(booking_portal_client_id: client_id, subject_class: "User", name: 'no_booking_day_4', content: "In case if you need a home loan, select loan preference and upload KYC so that our loan representative can help you.")  if ::Template::NotificationTemplate.where(name: "no_booking_day_4").blank?

      Template::NotificationTemplate.create!(booking_portal_client_id: client_id, subject_class: "User", name: 'no_booking_day_5', content: "Earn additional discounts at <%= current_project.name %> by completing your profile to help us know you better.")  if ::Template::NotificationTemplate.where(name: "no_booking_day_5").blank?

      Template::NotificationTemplate.create!(booking_portal_client_id: client_id, subject_class: "User", name: 'no_booking_day_6', content: "Thank for showing your preference for the loan requirement for your dream home at <%= current_project.name %>. We have a host financial partners who are offering home loans at competitive rates.")  if ::Template::NotificationTemplate.where(name: "no_booking_day_6").blank?

      Template::NotificationTemplate.create!(booking_portal_client_id: client_id, subject_class: "User", name: 'no_booking_day_7', content: "Earn additional discounts by referring your 3 friends at <%= current_project.name %>.")  if ::Template::NotificationTemplate.where(name: "no_booking_day_7").blank?

      Template::NotificationTemplate.create!(booking_portal_client_id: client_id, subject_class: "User", name: 'payment_link', content: ' <% if self.manager.present? && self.manager_role?("channel_partner") %>
