  ...
  module EmailTemplates
    module Receipt
      def self.seed(project_id, client_id)
        ...
        <div class="mt-3"></div>
        <%= current_client.templates.where(_type: "Template::ReceiptTemplate").first.parsed_content(self) %>') if ::Template::EmailTemplate.where(booking_portal_client_id: client_id, project_id: project_id, name: "receipt_success").blank?
        ...
        Template::EmailTemplate.create!(booking_portal_client_id: client_id, project_id: project_id, subject_class: "Receipt", name: "receipt_failed", subject: "Payment <%= self.receipt_id %> Failed", content: '<div class="card w-100">
          ...
          <div class="mt-3"></div>
          <%= current_client.templates.where(_type: "Template::ReceiptTemplate").first.parsed_content(self) %>') if ::Template::EmailTemplate.where(booking_portal_client_id: client_id, project_id: project_id, name: "receipt_failed").blank?
        ...
        <div class="mt-3"></div>
        <%= current_client.templates.where(_type: "Template::ReceiptTemplate").first.parsed_content(self) %>') if ::Template::EmailTemplate.where(booking_portal_client_id: client_id, project_id: project_id, name: "receipt_clearance_pending").blank?
        ...
        Template::EmailTemplate.create!(booking_portal_client_id: client_id, project_id: project_id, subject_class: "Receipt", name: "receipt_pending", subject: "Payment Receipt <%= self.receipt_id %> Collected", content: '<div class="card w-100">
          ...
          <div class="mt-3"></div>
          <%= current_client.templates.where(_type: "Template::ReceiptTemplate").first.parsed_content(self) %>') if ::Template::EmailTemplate.where(booking_portal_client_id: client_id, project_id: project_id, name: "receipt_pending").blank?
        ...
        Template::EmailTemplate.create!(booking_portal_client_id: client_id, project_id: project_id, subject_class: "Receipt", name: "receipt_refunded", subject: "Your refund for payment <%= self.receipt_id %> has been processed", content: '<div class="card w-100">
          ...
          <div class="mt-3"></div>
          <%= current_client.templates.where(_type: "Template::ReceiptTemplate").first.parsed_content(self) %>') if ::Template::EmailTemplate.where(booking_portal_client_id: client_id, project_id: project_id, name: "receipt_refunded").blank?
        ...
        Template::EmailTemplate.create!(booking_portal_client_id: client_id, project_id: project_id, subject_class: "Receipt", name: "receipt_available_for_refund", subject: "Your payment <%= self.receipt_id %> is available for refund.", content: '<div class="card w-100">
          ...
          <div class="mt-3"></div>
          <%= current_client.templates.where(_type: "Template::ReceiptTemplate").first.parsed_content(self) %>') if ::Template::EmailTemplate.where(booking_portal_client_id: client_id, project_id: project_id, name: "receipt_available_for_refund").blank?
