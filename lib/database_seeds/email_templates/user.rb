  ...
  module EmailTemplates
    module User
      def self.seed client_id
        ...
        Template::EmailTemplate.create!(booking_portal_client_id: client_id, subject_class: "User", name: "cp_user_register_in_company", subject: '<%= name %> has requested to register his account into your company on <%= I18n.t("global.brand", client_name: self.booking_portal_client.name) %>', content: '<div class="card w-100">
          <div class="card-body">
