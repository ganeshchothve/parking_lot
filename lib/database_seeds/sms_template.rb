...
module DatabaseSeeds
  module SmsTemplate
    def self.project_based_sms_templates_seed(project_id, client_id)
      ...
      # For Customer
      #
      Template::SmsTemplate.create!(booking_portal_client_id: client_id, project_id: project_id, subject_class: "SiteVisit", name: 'site_visit_scheduled_to_customer', content: 'Your site visit is scheduled on <%= I18n.l(scheduled_on) %> for <%= project.name %>. Please show this <%= I18n.t("mongoid.attributes.site_visit.code") %>: <%= self.code %> at the project site.') if ::Template::SmsTemplate.where(name: "site_visit_scheduled_to_customer", project_id: project_id, booking_portal_client_id: client_id).blank?

      Template::SmsTemplate.create!(booking_portal_client_id: client_id, project_id: project_id, subject_class: "SiteVisit", name: 'site_visit_conducted_to_customer', content: 'Your site visit for <%= project.name %> was successfully conducted') if ::Template::SmsTemplate.where(name: "site_visit_conducted_to_customer", project_id: project_id, booking_portal_client_id: client_id).blank?

      Template::SmsTemplate.create!(booking_portal_client_id: client_id, project_id: project_id, subject_class: "SiteVisit", name: 'site_visit_cancelled_to_customer', content: 'Your site visit scheduled on <%= I18n.l(scheduled_on) %> for <%= project.name %> is cancelled') if ::Template::SmsTemplate.where(name: "site_visit_cancelled_to_customer", project_id: project_id, booking_portal_client_id: client_id).blank?

      Template::SmsTemplate.create!(booking_portal_client_id: client_id, project_id: project_id, subject_class: "SiteVisit", name: 'site_visit_inactive_to_customer', content: 'Your site visit scheduled on <%= I18n.l(scheduled_on) %> for <%= project.name %> has been marked inactive. Please schedule a new visit') if ::Template::SmsTemplate.where(name: "site_visit_inactive_to_customer", project_id: project_id, booking_portal_client_id: client_id).blank?

      Template::SmsTemplate.create!(booking_portal_client_id: client_id, project_id: project_id, subject_class: "SiteVisit", name: 'site_visit_rescheduled_to_customer', content: 'Your site visit is rescheduled on <%= I18n.l(scheduled_on) %> for <%= project.name %>. Please show this <%= I18n.t("mongoid.attributes.site_visit.code") %>: <%= self.code %> at the project site.') if ::Template::SmsTemplate.where(name: "site_visit_rescheduled_to_customer", project_id: project_id, booking_portal_client_id: client_id).blank?

      #
      # For Channel Partner
      #
      Template::SmsTemplate.create!(booking_portal_client_id: client_id, project_id: project_id, subject_class: "SiteVisit", name: 'site_visit_scheduled_to_channel_partner', content: 'Site visit is scheduled on <%= I18n.l(scheduled_on) %> for <%= lead.name %> at <%= project.name %>. Please show this <%= I18n.t("mongoid.attributes.site_visit.code") %>: <%= self.code %> at the project site.') if ::Template::SmsTemplate.where(name: "site_visit_scheduled_to_channel_partner", project_id: project_id, booking_portal_client_id: client_id).blank?

      Template::SmsTemplate.create!(booking_portal_client_id: client_id, project_id: project_id, subject_class: "SiteVisit", name: 'site_visit_conducted_to_channel_partner', content: 'Site visit at <%= project.name %> for <%= lead.name %> was successfully conducted') if ::Template::SmsTemplate.where(name: "site_visit_conducted_to_channel_partner", project_id: project_id, booking_portal_client_id: client_id).blank?

      Template::SmsTemplate.create!(booking_portal_client_id: client_id, project_id: project_id, subject_class: "SiteVisit", name: 'site_visit_cancelled_to_channel_partner', content: 'Site visit scheduled on <%= I18n.l(scheduled_on) %> at <%= project.name %> for <%= lead.name %> is cancelled') if ::Template::SmsTemplate.where(name: "site_visit_cancelled_to_channel_partner", project_id: project_id, booking_portal_client_id: client_id).blank?

      Template::SmsTemplate.create!(booking_portal_client_id: client_id, project_id: project_id, subject_class: "SiteVisit", name: 'site_visit_inactive_to_channel_partner', content: 'Site visit scheduled on <%= I18n.l(scheduled_on) %> at <%= project.name %> for <%= lead.name %> has been marked inactive. Please schedule a new visit') if ::Template::SmsTemplate.where(name: "site_visit_inactive_to_channel_partner", project_id: project_id, booking_portal_client_id: client_id).blank?

      Template::SmsTemplate.create!(booking_portal_client_id: client_id, project_id: project_id, subject_class: "SiteVisit", name: 'site_visit_rescheduled_to_channel_partner', content: 'Site visit is rescheduled on <%= I18n.l(scheduled_on) %> for <%= lead.name %> at <%= project.name %>. Please show this <%= I18n.t("mongoid.attributes.site_visit.code") %>: <%= self.code %> at the project site.') if ::Template::SmsTemplate.where(name: "site_visit_rescheduled_to_channel_partner", project_id: project_id, booking_portal_client_id: client_id).blank?
