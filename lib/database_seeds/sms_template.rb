module DatabaseSeeds
  module SmsTemplate
    def self.seed client_id
      ::SmsTemplate.create({booking_portal_client_id: client_id, subject_class: "User", name: "otp", content: "Your OTP for logging into {{booking_portal_client.name}} is {{otp_code}}."})  if ::SmsTemplate.where(name: "otp").blank?
