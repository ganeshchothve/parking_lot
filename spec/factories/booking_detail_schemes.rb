FactoryBot.define do
  factory :booking_detail_scheme do
    ...
    association :derived_from_scheme, factory: :scheme
    ...
    after(:build) do |booking_detail_scheme|
      ...
      booking_detail_scheme.payment_schedule_template = booking_detail_scheme.derived_from_scheme.payment_schedule_template
      booking_detail_scheme.cost_sheet_template = booking_detail_scheme.derived_from_scheme.cost_sheet_template
      if booking_detail_scheme.payment_adjustments.blank?
